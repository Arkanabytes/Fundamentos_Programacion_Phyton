...
while True:
    try:
        ...
        if anio > 0: # si el año es mayor al 0, lo guardamos
            pelicula['anio'] = anio
            break
        else: # Si el año no es valido mostrasmos un mensaje
            print('Por favor ingrese un año superior al 0.')
            # En caso de error en la tipificacion debe ingresar un numero valido.
    except ValueError:
        print("Error: debe ingresar un número válido.")
# Paso 4: Mostrar la informacion recopilada 
print(f'\n La pelicula {pelicula["Titulo"]} fue dirigida por {pelicula["Director"]} estrenada en el año {pelicula["anio"]}')