...
# Si el numero es 0, numero no valid, que intente de nuevo y vuelva a pedir otro numero ( usa funcion continue) si el numero es 7, muestre secreto encontrado y detiene el bucle
